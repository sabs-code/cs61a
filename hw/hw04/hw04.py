...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, entry):
        ...
        nonlocal passwords
        if len(passwords)==3:
            return 'Your account is locked. Attempts: ' + str(passwords)
        if entry == password:
            if amount<= balance:
                balance -= amount
                return balance
...
class Coin:
    ...
    def worth(self):
        if Mint.current_year - self.year <= 50:
            ...
            return self.cents + abs(self.year - Mint.current_year) - 50
...
class VendingMachine:
    ...
    def vend(self):
        if self.stock == 0:
            ...
            self.balance = 0
            self.stock -= 1
            return 'Here is your ' + str(self.product) + ' and $' + str(self.change) + ' change.'
